...
public partial class TitledEntry : ContentView
{
    ...
    {
        Debug.WriteLine("TxtContent_HandlerChanged");
        Debug.WriteLine("=== RUNTIME INFO ===");
        Debug.WriteLine(System.Runtime.InteropServices.RuntimeInformation.FrameworkDescription);
        Debug.WriteLine(System.Runtime.InteropServices.RuntimeInformation.OSDescription);
    ...
    //public static readonly BindableProperty IconColorProperty =
    //    BindableProperty.Create(nameof(IconColor), typeof(Color), typeof(TitledEntry),
    ...
    //public static readonly BindableProperty GlyphProperty =
    //    BindableProperty.Create(nameof(Glyph), typeof(string), typeof(TitledEntry),
    //        defaultBindingMode: BindingMode.TwoWay);

    //public static readonly BindableProperty FontFamilyProperty =
    //    BindableProperty.Create(nameof(FontFamily), typeof(string), typeof(TitledEntry),
    //        defaultBindingMode: BindingMode.TwoWay);
    ...
    //public static readonly BindableProperty ShowIconProperty =
    //    BindableProperty.Create(nameof(ShowIcon), typeof(bool), typeof(TitledEntry),
    //        defaultValue: true);
