...
{
    public class HubMacroProductSubCategory : HubBase
    {
        ...
        public HubMacroProductSubCategory(AppSession _setAppSession) : base(_setAppSession)
        {
            EndPointApi = "/web/dataset/call_kw";
            _modelname = "macro.product.sub.category";
        }
        ...
        public async Task<ApiResponseOdooRpcT<macro_product_sub_category[]>?> GetByCreateDate(int limit, int index, int year, int month, int day)
        {            
            var kwargs = new
            {
                limit = limit,
