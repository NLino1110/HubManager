...
namespace ApiManager
{
    public class HubPaymentMethod
    {
        ...
        public async Task<ApiResponsePaymentMethod?> GetAll()
        {
            ...
            {
                var resultApi = Newtonsoft.Json.JsonConvert.DeserializeObject<ApiResponsePaymentMethod>(result.Content);
                return resultApi;
            }
