...
{
    public class HubAccountMoveLineSend : HubBase
    {
        ...
        public HubAccountMoveLineSend(AppSession _setAppSession) : base(_setAppSession)
        {
        ...
        public async Task<ApiResponseOdooRpcT<account_move_line_send[]>?> GetAccountMoveLineSend(int parent_move_id)
        {
            int limit = 100;
            int index = 0;
            int year = 0;
        ...
        public async Task<ApiResponseOdooRpcT<int>?> SendAccountMoveLine(account_move_line_send SendObject)
        {
            var kwargs = new { };
