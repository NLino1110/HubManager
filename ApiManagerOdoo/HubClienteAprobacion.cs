...
using DMSA.Models.Security.Proformas;
...
namespace ApiManager
{
    public class HubClienteAprobacion
    {
        ...
        [Obsolete]
        public Task<ApiResponse_v2?> GetForAgree()
        {
            //ApiResponse_v1 apiResponse_V1 = new ApiResponse_v1();
            return _client.GetAsync<ApiResponse_v2>(new RestRequest(EndPointApi+ "/GetByStatus/54"));
        }

        public Task<ApiResponse_v2?> GetForAgree(string codusuario, int codstatus)
        {
            //ApiResponse_v1 apiResponse_V1 = new ApiResponse_v1();
            string fullEndPoint = EndPointApi + $"/GetFromFacPedido/{codusuario}/{codstatus}";
            return _client.GetAsync<ApiResponse_v2>(new RestRequest(fullEndPoint));
        }

        public Task<ApiResponse_v2?> GetForAgree(int codagencia, int codstatus, string textobusqueda)
        {
            //ApiResponse_v1 apiResponse_V1 = new ApiResponse_v1();
        ...
        public Task<DMSA.Models.Clientes.Aprobaciones.Responses.ApiResponse_v1?> Add(ClienteAprobacion requestObject)
        {
            var restRequest = new RestRequest(EndPointApi);
            restRequest.RequestFormat = DataFormat.Json;
            restRequest.AddJsonBody(requestObject);

            return _client.PostAsync<DMSA.Models.Clientes.Aprobaciones.Responses.ApiResponse_v1>(restRequest);
        }

        public Task<DMSA.Models.Clientes.Aprobaciones.Responses.ApiResponse_v1?> AddWithFull(ClienteAprobacion requestObject)
        {
