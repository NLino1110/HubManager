...
namespace ApiTradeHub.Controllers.Sales
{
    ...
    public class FacPedidoController : ControllerBase
    {
            ...
            [FromHeader(Name = "X-API-Key")] string apiKey = null)
        {
            ...
            document.CodUsuario = "";
            CajCajas cajCajas = facPedidoService.GetFirstCajCajas(document.CodBodegaAgencia);
            if(cajCajas != null)
                document.CodUsuario = cajCajas.UsuarioCaja;
            else
                return StatusCode(500, AccessValidator.BuildError("Caja no encontrada", 500));
