...
namespace DMSA.Sync.Core.Update.Cloud
{
    ...
    {
        //public async Task<bool> DownloadFromFile(string dbPath, FileInfo existTmp, string dbPathCentral)
        //{
        //    if(existTmp != null)
        //    {
        ...
        //            if (await pipeline.DownloadSqliteZipCustom(dbPath,true))
        //            {
        ...
        //[Obsolete("Usar UploadToFileMode2")]

        //public async Task<bool> UploadToFile(string dbPath, string centralDB)
        //{
        //    Pipeline pipeline = new Pipeline();
        //    bool requiredNewUpload = await pipeline.RequiredNewUploadBasePack(dbPath);
        //    if (requiredNewUpload)
        //    {
        //        (var attachData, bool successUpload) = await pipeline.UploadSqliteZipCustom(dbPath);
