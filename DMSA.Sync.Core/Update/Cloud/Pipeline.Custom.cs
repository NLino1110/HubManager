...
namespace DMSA.Sync.Core.Update.Cloud
{
    public partial class Pipeline    
    {
        ...
        public async Task<mnsa_attachment> NewestZipPack(string dbNameSqlite)
        {
        ...
        {
            MnsaAttachmentDb mnsaAttachmentDb = new MnsaAttachmentDb(dbNameSqlite);
            var record = await mnsaAttachmentDb.GetLastUpdate(dbPath);
            return record != null;
        }

        public async Task<bool> InsertAttachRecordCustom(string dbNameSqlite, mnsa_attachment mnsa_Attachment)
        {
            MnsaAttachmentDb mnsaAttachmentDb = new MnsaAttachmentDb(dbNameSqlite);
            await mnsaAttachmentDb.InsertAsync(mnsa_Attachment);
            return true;
        }
    }
}
