...
namespace DMOrders.Services.Update
{
    public partial class ServerPuller
    {
        ...
        public ServerPuller(string _DbNameSqlite) 
        {
        ...
        {
            var database = new CompanyDb(DbNameSqlite);
            ...
            ApiManager.HubCompany hubCompany = new HubCompany(appSession);
