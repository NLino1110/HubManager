...
namespace DMSA.Sync.Core.Controls.Popups
{
    public class PopupSelectPartnerSingle : PopupSelectBase<res_partner>
    {
        ...
        async Task<int> LoadData()
        {
            ...
            resultItemsSearch = new ObservableCollection<res_partner>(await partnerBankDb.GetItemsBySearchAsyncWithChannel(Company.id, TextForSearch.ToUpper(), 25));
        ...
        public override CollectionView builCollectionViewCustom()
        {
            ...
            {
                var row = new ResPartnerSingleRow();
