...
{
    public class AccountMoveSendHeaderItem : SwipeView
    {
        public static readonly BindableProperty DataItemProperty =
            BindableProperty.Create(nameof(DataItem), typeof(AccountMoveSendHeader), typeof(AccountMoveSendHeaderItem), null);

        public AccountMoveSendHeader DataItem
        {
            get => (AccountMoveSendHeader)GetValue(DataItemProperty);
        ...
        public AccountMoveSendHeaderItem()
        {            
