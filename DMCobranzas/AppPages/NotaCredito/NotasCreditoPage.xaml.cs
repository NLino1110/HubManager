...
public partial class NotasCreditoPage : ContentPage
{
    ...
    public string SearchText
    {
        ...
        set
        {
            ...
            // aquï¿½ puedes ejecutar bï¿½squeda si quieres
            //PerformSearch();
        }
    }
    ...
    {        
        ...
        try
        {
            ...
            foreach (var _accountMoveItem in ls_items)
            {
                ...
                {
                    // Ejecutar la funciï¿½n que recibe los registros de la fecha anterior
    ...
    private async void SendItemHeader(object obj)
    {
        ...
        //        "Al parecer se han ingresado valores inadecuados para las devoluciones, modif�quelos y vuelva a intentar.",
        //        "Cancelar");
