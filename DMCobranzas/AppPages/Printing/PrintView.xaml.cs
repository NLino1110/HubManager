...
public class TextProcessor
{
    public List<string> ProcessText(string texto)
    {
        ...
        // Dividir el texto original en l�neas
        var lines = texto.Split('\n');

        foreach (var line in lines)
        {
            // Si la l�nea contiene "Cliente:" y es mayor a 25 caracteres, procesarla
            ...
            {
                // Si la l�nea no necesita procesamiento especial, a�adirla directamente
                processedLines.Add(line);
            }
        }
...
public partial class PrintView : ContentPage
{
    ...
    public async Task<SKBitmap> BuildImageFromText(string texto)
    {
        ...
        // Establecer un tama�o más grande para el lienzo seg�n la longitud del texto
        ...
        var canvasWidth = 620; // Ajusta seg�n sea necesario
        var canvasHeight = multiploLinea * lineasCount;//1000; // Ajusta seg�n sea necesario
        ...
        using (var surface = SKSurface.Create(new SKImageInfo((int)canvasWidth, (int)canvasHeight, SKColorType.Bgra8888, SKAlphaType.Premul)))
        {
            ...
            using (var consolasTypeface = SKTypeface.FromStream(fontStream))
            {
                ...
                // Configurar el tipo y tama�o de la fuente
                ...
                // Dividir el texto en l�neas y dibujar cada l�nea en el lienzo
                //var lineas = texto.Split('\n');
                var yPos = 50 + logoHeight; // Ajustar seg�n sea necesario
                ...
                foreach (var linea in lineas)
                {
                    ...
                    // Crear un SKTextBlob para manejar saltos de l�nea y formato
                ...
                // Tomar la instant�nea como SKImage
