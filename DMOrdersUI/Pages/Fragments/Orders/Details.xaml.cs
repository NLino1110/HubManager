...
using DMOrdersUI.Services.Update.Pusher;
using DMOrdersUI.Shared;
...
public partial class Details : ContentPage, IBackButtonHandler
{
    ...
    protected override bool OnBackButtonPressed()
    {
        ...
        {
            var leave = await ServicesExposer.DialogService.ConfirmAsync("Atención",
                    $"Los cambios que haya realizado no se guardarán. \n¿Desea continuar?",
                    "Si",
                    "No");
