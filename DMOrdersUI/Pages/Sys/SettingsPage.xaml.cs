...
public partial class SettingsPage : ContentView, IDisposable //, INotifyPropertyChanged
{    
    public SettingsPage()
	{        
        //Scan(null, null);
    ...
    {        
        ...
        else
        {
            ...
            var resultAlert = await PopupExtensions.ShowPopupAsync(App.Current.MainPage, returnAlertTest);
        }
