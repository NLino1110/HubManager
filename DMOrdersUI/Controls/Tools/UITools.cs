...
namespace DMOrdersUI.Controls.Tools
{
    public static class UITools
    {
        ...
        private static DMOrdersUI.Controls.PopupLoadingTask simplePopup = null;
        ...
        public static async Task ShowLoadingPopup(ContentPage contentPage)
        {
            ...
            simplePopup = new DMOrdersUI.Controls.PopupLoadingTask(popupSizeConstants);
