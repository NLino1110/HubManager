...
{
    public class ActivityRowV2 : SwipeView
    {
        public static readonly BindableProperty DataItemProperty =
            BindableProperty.Create(nameof(DataItem), typeof(ActivityHeader), typeof(ActivityRowV2), null);

        public ActivityHeader DataItem
        {
            get => (ActivityHeader)GetValue(DataItemProperty);
        ...
        {            
            ...
            BindwithDataProperty(LabelRow01, "partner_display");
            ...
            LabelPrefixRow02.SetBinding(Label.TextProperty, new Binding("request_name", source: DataItem));
            ...
            LabelRow02 = new Label
            {
                ...
                Padding = new Thickness(110, 0, 0, 0)
            };

            LabelRow02.SetBinding(Label.TextProperty, new Binding("create_datetime", source: DataItem));
            ...
            indicatorLabel.SetBinding(IndicatorLabelUI.TextProperty, new Binding("request_status", source: DataItem));

            var dataTrigger = new DataTrigger(typeof(IndicatorLabelUI))
            {
                Binding = new Binding("request_status", source: DataItem),
                Value = "PENDIENTE"
            };
        ...
        private void BindwithDataProperty(Label LabelObject, string dataProperty)
        {
            LabelObject.SetBinding(Label.TextProperty, new Binding(dataProperty, source: DataItem));
        }
        ...
        private StackLayout BuildButtonsBox()
        {
            ...
            var btnEnviar = BuildButton("ENVIAR", "\uf1d8", "SendItemCommand", Colors.DeepSkyBlue, Colors.WhiteSmoke, Colors.WhiteSmoke, "DataItem");
            var btnDelete = BuildButton("BORRAR", "\uf2ed", "DeleteCommand", Colors.AntiqueWhite, Colors.Black, Colors.Black, "DataItem");
            ...
            {
                Binding = new Binding("request_status"),
                Value = "PENDIENTE",
                Setters =
                {
                    new Setter { Property = Button.IsVisibleProperty, Value = true }
            ...
            btnDelete.Triggers.Add(new DataTrigger(typeof(Button))
            {
                Binding = new Binding("request_status", source: DataItem),
                Value = "PENDIENTE",
                Setters =
